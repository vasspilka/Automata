var UI = {
    ...
    init: function() {
        ...
        if (user) {
          ...
          $('#user').html('<ol class=\"account\"><li><img src=\"'+user.picture+'\" class=\"avatar\" width=\"27\" height=\"27\" />'+user.name+'</a></li><a href=\"api/logout\">Sign out</a></ol>');
        }
        else {
          $('#user').html('<ol class=\"account\"><a href="api/login">Log in with Google</a></ol>');
        }
    }
};
UI.init();
